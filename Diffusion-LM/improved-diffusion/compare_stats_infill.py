...
filename = '/n/holyscratch01/rush_lab/Users/yuntian/slurm_smaller_roc_stories/encoder_28289/run_l0.0005_b32/diffusion/zs.pt.masked'
...
plt.savefig('infill_mean_comp.png', bbox_inches='tight', pad_inches=0.1, dpi=200,)
...
axes[1].cax.colorbar(im1)
axes[1].cax.toggle_label(True)
plt.savefig('infill_std_comp.png', bbox_inches='tight', pad_inches=0.1, dpi=200,)
