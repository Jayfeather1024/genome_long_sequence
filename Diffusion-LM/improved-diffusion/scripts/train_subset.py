...
from improved_diffusion.text_datasets import load_data_text, load_data_highlevel_subset
...
from improved_diffusion.train_util import TrainLoop, TrainLoopHighLevel
...
def main():
    ...
    if args.modality == 'image':
        ...
        if args.training_mode == 'highlevel':
            data = load_data_highlevel_subset(
                data_dir=args.data_dir,
                batch_size=args.batch_size,
                image_size=args.image_size,
                class_cond=args.class_cond,
        ...
        elif args.modality == 'highlevel-tgt':
            tokenizer = None
            rev_tokenizer = None
        else:
            rev_tokenizer = {v: k for k, v in tokenizer.items()}
        ...
        if args.training_mode == 'highlevel':
            data_valid = load_data_highlevel_subset(
                data_dir=args.data_dir,
                batch_size=args.batch_size,
                image_size=args.image_size,
                class_cond=args.class_cond,
