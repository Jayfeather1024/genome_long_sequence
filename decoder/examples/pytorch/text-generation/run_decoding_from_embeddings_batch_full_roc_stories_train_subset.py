...
def main():
    ...
    for sss in range(1, 6):
        with open(f'mar23_debug/oracle{use_oracle}_beam1_max{total_num_samples}_feb14_notuselatent_{model.not_use_latent}_gt_{sss}.txt', 'w') as fgt:
            with open(f'mar23_debug/oracle{use_oracle}_beam1_max{total_num_samples}_feb14_notuselatent_{model.not_use_latent}_gen_{sss}.txt', 'w') as fgen:
