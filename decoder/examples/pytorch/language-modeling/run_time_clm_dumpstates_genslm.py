...
def get_data_paths(data_args: DataTrainingArguments):
    ...
    assert data_args.dataset_name in [
        'wikisection', 'roc_stories', 'wikihow', 'recipe', 'tm2', 'tickettalk', 'tm2newsep', 'tm2new', 'genome_sars']
    # Default datapaths
...
def get_dataset(
    ...
    elif 'tm2' == args.dataset_name or 'tickettalk' in args.dataset_name:
    ...
    elif 'tm2new' == args.dataset_name or 'tickettalk' in args.dataset_name:
    ...
    elif 'tm2newsep' == args.dataset_name or 'tickettalk' in args.dataset_name:
...
def not_used_get_special_tokens(dataset_name, tokenizer, add_tokens=True):
    SECTION_IDS = []
...
def main():
    ...
    trainer = Trainer_Time(
        ...
        val_dataset=val_dataset if training_args.do_eval else None,
        tokenizer=tokenizer,
    ...
    if training_args.do_train:
        ...
        train_result = trainer.train_dump(resume_from_checkpoint=checkpoint, fname=data_args.fname)
