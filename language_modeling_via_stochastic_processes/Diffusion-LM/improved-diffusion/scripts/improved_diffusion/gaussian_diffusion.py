...
class GaussianDiffusion:
    ...
    def training_losses(self, model, *args, **kwargs):
        ...
        if self.training_mode == 'highlevel':
            return self.training_losses_highlevel(model, *args, **kwargs)
    ...
    def p_sample_infill_loop(
        ...
        """
        final = None
        for sample in self.p_sample_loop_progressive_infill(
            model,
            shape,
            partial_enc,
            partial_mask,
    ...
    def p_sample_infill_repaint_loop(
        self,
        model,
        shape,
        partial_enc,
        ...
        """
        final = None
        for sample in self.p_sample_loop_progressive_infill_repaint(
            model,
            shape,
            partial_enc,
            partial_mask,
    ...
    def p_sample_loop_progressive_infill_repaint(
        self,
        model,
        shape,
        partial_enc,
        ...
        times = get_schedule_jump(250,1,10,10)
    ...
    def training_losses_highlevel(self, model, x_start, t, model_kwargs=None, noise=None):
        """
        Compute training losses for a single timestep.
