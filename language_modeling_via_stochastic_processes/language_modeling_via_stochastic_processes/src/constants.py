...
REPO_PATH='/home/jiongxiao/language_modeling_via_stochastic_processes/' # CHANGE ME! 
PATH2HUGGINGFACE='/home/jiongxiao/language_modeling_via_stochastic_processes/' # CHANGE ME! 
...
PATH2ROCSTORIESGENSLM=os.path.join(DATA_PATH,'roc_stories_genslm')
