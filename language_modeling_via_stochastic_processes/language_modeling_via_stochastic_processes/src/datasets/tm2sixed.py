...
class TM2SixedDataset(encoder.BaseDataset):
    ...
    def _set_section_names(self):
        ...
        self.section_ids = ['[ {} ]'.format(name.upper()) for name in self.section_names] + ['[ END ]']
        ...
        for fname in self.data_files:
            ...
            for conversation in data:
                ...
                for utterance in conversation['utterances']:
                    ...
                    sentence_counter += 1
### <|endoftext|> [ USER ]| x y z. [ AST ]| a b c. [ USER ]| d e f. [ END ]|<|endoftext|>
                sentence_info = {
                    "sentence": '<|endoftext|>',
                    "sentence_id": sentence_counter,
                    "doc_id": doc_id,
...
class TM2SixedDiscourse(TM2SixedDataset):
...
class TM2SixedTriplet(TM2SixedDataset):
...
class TM2SixedCBow(TM2SixedDataset):
...
class TM2SixedTPK(TM2SixedDataset):
    ...
    def __init__(
        ...
        """
        """
        super(TM2SixedTPK, self).__init__(
            train=train,
            all_dataset=all_dataset,
            config=config,
            tokenizer_name=tokenizer_name,
