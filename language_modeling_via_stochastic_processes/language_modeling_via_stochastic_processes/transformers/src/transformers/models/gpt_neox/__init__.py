...
if is_torch_available():
    ...
    _import_structure["modeling_time_gpt_neox"] = [
        "GPTNeoXTimeForCausalLM",
        "GPTNeoXTimeModel",
    ]
    _import_structure["modeling_chunk_gpt_neox"] = [
...
if TYPE_CHECKING:
    ...
    if is_torch_available():
        ...
        from .modeling_time_gpt_neox import (
            GPTNeoXTimeModel,
            GPTNeoXTimeForCausalLM,
        )
        from .modeling_chunk_gpt_neox import (
            GPTNeoXChunkModel,
            GPTNeoXChunkForCausalLM,
        )
