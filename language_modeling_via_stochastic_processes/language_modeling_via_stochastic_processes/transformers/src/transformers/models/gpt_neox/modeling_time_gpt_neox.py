...
class GPTNeoXPreTrainedModel(PreTrainedModel):
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, GPTNeoXTimeModel):
...
class GPTNeoXTimeModel(GPTNeoXPreTrainedModel):
    def __init__(self, config):
    ...
    def forward(
        ...
        #import pdb; pdb.set_trace()
        if self.config.use_contrastive_embeddings:
...
class GPTNeoXTimeForCausalLM(GPTNeoXPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.gpt_neox = GPTNeoXTimeModel(config)
