...
from transformers import (
    ...
    DataCollatorForTimeControlChunk,
    WikisectionDataset,
...
def get_data_collator(
        args: DataTrainingArguments,
        tokenizer: PreTrainedTokenizer):
    data_collator = DataCollatorForTimeControlChunk(tokenizer=tokenizer)
...
def main():
    ...
    # training_args.learning_rate = 1e-99
    ...
    config.encoder_mode = data_args.encoder_mode
