...
REPO_PATH='/lus/eagle/projects/CVD-Mol-AI/for_yuntian/genome_long_sequence/' # CHANGE ME! 
PATH2HUGGINGFACE='/lus/eagle/projects/CVD-Mol-AI/for_yuntian/genome_long_sequence/' # CHANGE ME! 
...
PATH2TRANSFORMERS=os.path.join(REPO_PATH, 'decoder')
...
PATH2GENOMESARS=os.path.join(DATA_PATH,'genome_sars')
